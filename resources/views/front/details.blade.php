...
<body>
  <main class="bg-[#FAFAFA] max-w-[640px] mx-auto min-h-screen relative flex flex-col has-[#CTA-nav]:pb-[120px] has-[#Bottom-nav]:pb-[120px]">
        ...
        <div class="tabs-contents">
          <div id="about-tab" class="tabcontent flex hidden">
            <div class="flex flex-col gap-5">
              <p class="leading-[28px]">Simbah Komputer selalu memberikan pelayanan extra terbaik untuk unit anda sehingga terlihat lebih sukses.</p>
              ...
              <div class="reviews-card flex gap-3 pb-4 border-b border-[#E9E8ED] w-full last-of-type:border-b-0">
                ...
                <div class="flex flex-col gap-1 w-full">
                  <div class="flex items-center justify-between">
                    <p class="font-semibold text-sm leading-[21px]">Anisa Putri</p>
                  ...
                  <p class="text-sm leading-[24px] text-[#909DBF]">Langganan tempat service laptop saya dikala sedang rewel</p>
                </div>
              </div>
              <div class="reviews-card flex gap-3 pb-4 border-b border-[#E9E8ED] w-full last-of-type:border-b-0">
                <div class="w-[50px] h-[50px] flex shrink-0">
                ...
                <div class="flex flex-col gap-1 w-full">
                  <div class="flex items-center justify-between">
                    <p class="font-semibold text-sm leading-[21px]">Joko Perkasa</p>
                    <div class="flex shrink-0">
                      <div class="w-[14px] h-[14px] flex shrink-0">
                        <img src="{{asset('assets/images/icons/Star 1.svg')}}" alt="star">
                      </div>
                  ...
                  <p class="text-sm leading-[24px] text-[#909DBF]">Teknisi profesianal pc saya diservice dengan baik</p>
                </div>
              </div>
              <div class="reviews-card flex gap-3 pb-4 border-b border-[#E9E8ED] w-full last-of-type:border-b-0">
                <div class="w-[50px] h-[50px] flex shrink-0">
                ...
                <div class="flex flex-col gap-1 w-full">
                  <div class="flex items-center justify-between">
                    <p class="font-semibold text-sm leading-[21px]">Momon</p>
                    <div class="flex shrink-0">
                      <div class="w-[14px] h-[14px] flex shrink-0">
                        <img src="{{asset('assets/images/icons/Star 1.svg')}}" alt="star">
                      </div>
                  ...
                  <p class="text-sm leading-[24px] text-[#909DBF]">Teknisi handal dan profesianal laptop saya tidak trobel lagi</p>
                </div>
              </div>
              <div class="reviews-card flex gap-3 pb-4 border-b border-[#E9E8ED] w-full last-of-type:border-b-0">
                <div class="w-[50px] h-[50px] flex shrink-0">
                ...
                <div class="flex flex-col gap-1 w-full">
                  <div class="flex items-center justify-between">
                    <p class="font-semibold text-sm leading-[21px]">asep</p>
                    <div class="flex shrink-0">
                      <div class="w-[14px] h-[14px] flex shrink-0">
                        <img src="{{asset('assets/images/icons/Star 1.svg')}}" alt="star">
                      </div>
                  ...
                  <p class="text-sm leading-[24px] text-[#909DBF]">ramah printer saya ditangai dengan baik masnya gokil</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="rounded-2xl border border-[#E9E8ED] flex items-center justify-between p-4 bg-white">
                  <div class="flex items-center gap-[10px]">
                    ...
                    <div class="flex flex-col h-fit">
                      ...
                      <p class="text-sm leading-[21px] text-[#909DBF]">Teknisi</p>
                    </div>
                  </div>
                  <a href="{{$Store->phone_number}}" class="appearance-none font-semibold text-sm leading-[21px] hover:underline text-[#FF8E62]">Call Now</a>
                </div>
              </div>
            </div>
          </div>
    ...
    <div id="CTA-nav" class="fixed bottom-0 w-full max-w-[640px] mx-auto border-t border-[#E9E8ED] flex items-center justify-between p-[16px_24px] bg-white z-20">
      ...
      @if($Store->is_open)
      @if($Store->is_full)
          <a href="" class="rounded-full p-[12px_20px] bg-[#EEFF4] font-bold text-[#AAADBF]">Full Booked</a>
      @else
          <a href="{{ route('front.booking', $Store->slug) }}" class="rounded-full p-[12px_20px] bg-[#FF8E62] font-bold text-white">Booking Now</a>
      @endif
        @else
            <a href="" class="rounded-full p-[12px_20px] bg-[#EEFF4] font-bold text-[#AAADBF]">Closed</a>
        @endif
